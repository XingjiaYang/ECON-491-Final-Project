...
if (file.exists("tuned_rf.rds")) {
    
    tuned_rf = readRDS("tuned_rf.rds")
    model_rf = readRDS("model_rf.rds")
    recipe_rf = readRDS("recipe_rf.rds")
    cv_model_rf = readRDS("cv_model_rf.rds")
    workflow_rf = readRDS("workflow_rf.rds")
    grid_rf = readRDS("grid_rf.rds")
