...
From the output, I can see that best random forest model has 11 predictors with 900 trees. Therefore, I will use it to get the rmse.
...
pred_knn = predict(final_fit_rf, new_data = set_test)$.pred
...
if (file.exists("objects/tuned_boost.rds")) {
    
    model_boost = readRDS("objects/model_boost.rds")
    recipe_boost = readRDS("objects/recipe_boost.rds")
    workflow_boost = readRDS("objects/workflow_boost.rds")
    cv_model_boost = readRDS("objects/cv_model_boost")
    grid_boost = readRDS("objects/grid_boost.rds")
    tuned_boost = readRDS("objects/tuned_boost.rds")
    ...
    saveRDS(model_boost, "objects/model_boost.rds")
    saveRDS(recipe_boost, "objects/recipe_boost.rds")
    saveRDS(workflow_boost, "objects/workflow_boost.rds")
    saveRDS(cv_model_boost, "objects/cv_model_boost.rds")
    saveRDS(grid_boost, "objects/grid_boost.rds")
    saveRDS(tuned_boost, "objects/tuned_boost.rds")
}
...
I can see that the rmse of kNN model is 1.459248. This rmse value is significantly smaller than elastic net. 
...
if (file.exists("tuned_svr.rds")) {
    ...
    model_svr = readRDS("objects/model_svr.rds")
    recipe_svr = readRDS("objects/recipe_svr.rds")
    workflow_svr = readRDS("objects/workflow_svr.rds")
    cv_model_svr = readRDS("objects/cv_model_svr.rds")
    grid_svr = readRDS("objects/grid_svr.rds")
    tuned_svr = readRDS("objects/tuned_svr.rds")
    ...
    saveRDS(model_svr, "objects/model_svr.rds")
    saveRDS(recipe_svr, "objects/recipe_svr.rds")
    saveRDS(workflow_svr, "objects/workflow_svr.rds")
    saveRDS(cv_model_svr, "objects/cv_model_svr.rds")
    saveRDS(grid_svr, "objects/grid_svr.rds")
    saveRDS(tuned_svr, "objects/tuned_svr.rds")
